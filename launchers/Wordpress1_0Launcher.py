...
class Wordpress1_0Launcher(WebAppLauncher):
    ...
    def setup_wp(self):
        ...
        with requests.Session() as s:
            ...
            data = {'step' : '3', 'url' : 'http://localhost:8080'}
            s.post('http://localhost:8080/wp-admin/install.php?step=3', headers=headers, data=data)
