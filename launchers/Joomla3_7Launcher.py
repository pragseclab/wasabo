...
class Joomla3_7Launcher(WebAppLauncher):
    ...
    def setup_joomla(self):
        with requests.Session() as s:
            ...
            # Step 6
            url = 'http://localhost:8080/installation/index.php?task=InstallDatabase_backup'
            data = {
                "format: json": "",
                token: "1"
            }
            ...
            # Step 7
            url = 'http://localhost:8080/installation/index.php?task=InstallDatabase'
            data = {
                "format: json": "",
                token: "1"
            }
            ...
            # Step 8
            url = 'http://localhost:8080/installation/index.php?task=InstallConfig'
            data = {
                "format: json": "",
                token: "1"
            }
