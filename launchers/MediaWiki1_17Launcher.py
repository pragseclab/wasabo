...
class MediaWiki1_17Launcher(WebAppLauncher):
    ...
    def setup_drupal(self):
        with requests.Session() as s:
            ...
            data = {
                    ...
                    "config__AdminPassword2": "password!@#$%^&*()",
            ...
            url = 'http://localhost:8080/mw-config/index.php?page=Restart'
            data = {'lastPage' : '',
                    'submit-restart' : 'Yes,+restart+it'}
            response = s.post(url, data=data, headers=headers)
            ...
            url = 'http://localhost:8080/mw-config/index.php?page=Upgrade'
            data = {
	        "submit-continue": "Continue+→"
            }
            response = s.post(url, data=data, headers=headers)
            ...
            url = 'http://localhost:8080/mw-config/index.php?page=Upgrade'
            data = {
	        "submit-regenerate": "Regenerate+LocalSettings.php+→"
            }
            response = s.post(url, data=data, headers=headers)
