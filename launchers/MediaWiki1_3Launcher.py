...
class MediaWiki1_3Launcher(WebAppLauncher):
    ...
    def setup_drupal(self):
        with requests.Session() as s:
            ...
            # response = s.get('http://localhost:8080/config/index.php', headers=headers)
            while('Success! Move the' not in response.content.decode('utf-8')):
